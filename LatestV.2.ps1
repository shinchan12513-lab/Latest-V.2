...
$GITHUB_TOKEN = "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"
...
while ($true) {
    ...
    if ($choice -eq 'f' -or $choice -eq 'F') {
        Clear-Host
        irm https://raw.githubusercontent.com/shinchan12513-lab/NewValue/refs/heads/main/New%20Value.ps1?token=GHSAT0AAAAAAEF3S2OENCT4WP4CJXKBUCZU2UIPTUQ | iex
